...
//    List<User> findAllUsersWithFiltering(Pageable pageable, String username, String name, String email, UserRole role, Status status);
    ...
    List<User> findAllUsersWithFiltering(Pageable pageable,
                                @Param("username") String username,
